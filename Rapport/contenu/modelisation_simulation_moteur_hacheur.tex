...
% TODO: Ajouter la figure du schéma PSIM avec charge
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{images/moteur_avec_charge/Schéma moteur avec charge Psim.png}
...
% TODO: Ajouter la comparaison des résultats
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.85\textwidth]{images/moteur_avec_charge/Comparaison courant moteur avec charge.png}
%     
%     \vspace{0.5cm}
%     
%     \includegraphics[width=0.85\textwidth]{images/moteur_avec_charge/Comparaison vitesse moteur avec charge.png}
