...
\hline
$N$ & vitesse de définition & 3\,000 & tr/min \\
\hline
\multicolumn{4}{|c|}{\textbf{Paramètres maximaux}} \\
\hline
$U_{max}$ & tension maximale & 65 & V \\
\hline
$N_{max}$ & vitesse maximale & 4\,800 & tr/min \\
\hline
...
\section{Spécifications du cahier des charges}
...
\subsection*{Asservissement en vitesse}
\begin{itemize}
    \item Temps de réponse à 5\% divisé par 3 par rapport à la boucle ouverte
    \item Depassement maximal de 20\%
\end{itemize}
