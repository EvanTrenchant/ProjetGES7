...
%mot en jaune surligné pour dire de faire des modifications ici
\textcolor{yellow}{Attention faut modifier}

\noindent
\begin{minipage}[t]{0.48\textwidth}
\vspace{0pt}
Pour réaliser le limiteur de courant que nous avions mis en place en simulation, nous utilisons un montage écrêteur à diodes et ponts diviseurs de tension.
