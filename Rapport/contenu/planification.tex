...
\clearpage
% Changement manuel de la taille de la page PDF et de la géométrie pour un "vrai" paysage
\pdfpagewidth=297mm
\pdfpageheight=210mm
% On force la largeur du texte à une valeur adaptée au format paysage (A4 ~29.7cm - 4cm marges =~ 25.7cm)
% On ajoute 'landscape' pour que geometry permute théoriquement les dimensions papier, 
% et on spécifie explicitement textwidth pour être sûr.
\newgeometry{landscape, left=2cm, right=2cm, top=2.5cm, bottom=1.5cm, headheight=34pt, footskip=24pt, headsep=0.5cm, textwidth=25cm}
\setlength{\headwidth}{\textwidth} % Important : mise à jour de la largeur de l'en-tête fancyhdr
...
\clearpage
\restoregeometry
\setlength{\headwidth}{\textwidth} % Restauration de la largeur de l'en-tête pour le mode portrait
\pdfpagewidth=210mm
\pdfpageheight=297mm