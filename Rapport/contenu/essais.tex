...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Essais/Limteur courant 15_01.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Essais/Graphe_Comparaison_Courant_Tachy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Essais/Graphe_Comparaison_Vitesse_Tachy.png}
...
On remarque encore que les trois courbes sont très proches les unes des autres, ce qui confirme que notre dimensionnement répond bien aux exigences que nous voulions. \\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Essais/Graphe_Comparaison_Courant_Codeur.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Essais/Graphe_Comparaison_Vitesse_Codeur.png}
