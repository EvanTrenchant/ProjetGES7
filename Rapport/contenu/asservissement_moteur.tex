...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/BO_Vitesse/Schéma_Simulink_BO_Vitesse.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/BF_Vitesse/Schéma_Simulink_BF_Vitesse.png}
