...
\begin{tcolorbox}[colback=conclusioncolor!5!white, colframe=conclusioncolor!75!black, boxrule=0.5pt, arc=2mm]
    \begin{itemize}
        \item Gain proportionnel : $K_p = 0{,}084$
        \item Gain intégral : $K_i = 254{,}3$
    \end{itemize}
\end{tcolorbox}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Codeur Incremental/Schéma_PSIM_Codeur_Incrementale.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Codeur Incremental/Schéma_PSIM_BF_Vitesse_Plus_Codeur_Incrementale.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Codeur Incremental/Graphe_Comparaison_BF_Vitesse_Codeur_Incrementale.png}
    \caption{Comparaison des résultats entre Simulink et PSIM avec codeur incrémental}
